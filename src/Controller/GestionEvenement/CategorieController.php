...
final class CategorieController extends AbstractController
{
    ...
    #[Route('/dashboard/addCategorie', name: 'add_categorie', methods: ['GET', 'POST'])]
