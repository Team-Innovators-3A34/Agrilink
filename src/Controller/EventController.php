...
final class EventController extends AbstractController
{
    ...
    #[Route('/add_event', name: 'add_event', methods: ['GET', 'POST'])]
    public function create(Request $request): Response
    {
        ...
        return $this->render('backOffice/Event/addEvent.html.twig', [
            "form" => $form->createView(),
        ]);
    }
        ...
        #[Route('/edit_event/{id}', name: 'edit_event', methods: ['GET', 'POST'])]
    ...
    #[Route('/display_event', name: 'display_event', methods: ['GET', 'POST'])]
    public function display(Request $request, EventRepository $eventRepository): Response
    {
        ...
        return $this->render('backOffice/Event/listEvent.html.twig', [
            'events' => $events,
            'sortField' => $sortField,
    ...
    #[Route('/display_event_front', name: 'display_event_front', methods: ['GET', 'POST'])]
