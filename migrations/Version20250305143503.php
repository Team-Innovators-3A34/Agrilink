 ...
 */
final class Version20250305143503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, post_id_id INT NOT NULL, user_commented_id INT NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_toxic TINYINT(1) DEFAULT 0 NOT NULL, toxicity_score DOUBLE PRECISION DEFAULT NULL, INDEX IDX_9474526CE85F12B8 (post_id_id), INDEX IDX_9474526C416BDDA3 (user_commented_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
