 ...
 */
final class Version20250217100227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, nom_user VARCHAR(255) NOT NULL, mail_user VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, date DATETIME DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, priorite INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_CE60640479F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponses (id INT AUTO_INCREMENT NOT NULL, id_reclamation_id INT NOT NULL, content VARCHAR(255) NOT NULL, date DATETIME DEFAULT NULL, is_auto TINYINT(1) DEFAULT NULL, INDEX IDX_1E512EC6100D1FDF (id_reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
