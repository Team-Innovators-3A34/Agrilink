 ...
 */
final class Version20250205115727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressources ADD image VARCHAR(255) DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demandes_ressources (demandes_id INT NOT NULL, ressources_id INT NOT NULL, INDEX IDX_B57BECB23C361826 (ressources_id), INDEX IDX_B57BECB2F49DCC2D (demandes_id), PRIMARY KEY(demandes_id, ressources_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE ressources DROP image, CHANGE type type VARCHAR(255) NOT NULL');
